    ...
    <div>
      ...
      <div className="page">
        <div className=" flex flex-col md:grid md:grid-cols-3 lg:grid-cols-4 gap-5 lg:gap-10">
          <div className=" flex flex-row md:flex-col border border-red-500 px-5 py-8 md:px-2 min-w-64 h-56 md:h-110 md:overflow-y-scroll overflow-x-scroll md:overflow-x-hidden">
          ...
          <div className=" h-110 md:col-span-2 lg:col-span-3 border border-cusGray">
          <iframe
            width="100%"
            height="100%"
            frameBorder=""
