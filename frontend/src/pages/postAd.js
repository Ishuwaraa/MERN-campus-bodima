                ...
                <form action="" onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
                    ...
                    <div className="flex flex-col justify-center mx-5 md:mx-20 lg:mx-40 mt-3 mb-10">
                        ...
                        <div className="lg:px-20 mb-3">
                            ...
                            <input type="text" name='latitude' required className='input' placeholder='Enter latitude'
                                value={latitude} onChange={(e) => setLatitude(e.target.value)} />
                        </div>
                        <div className="lg:px-20 mb-3">
                            <p className='mt-3 mb-1 w-full text-secondary font-semibold text-xl'>Longitude</p>
                            <input type="text" name='longitude' required className='input' placeholder='Enter longitude'
                        ...
                        <div className="lg:px-20 mb-3">
                            ...
                            {dropdownVisible && (
                                <div>
                                    {
                                        // if filtered array not empty showing results otherwise showing full list
                                        filterData.length > 0 ? (
                        ...
                        <div className="lg:px-20 mb-3">
                            ...
                            <label htmlFor="female" className='mr-8 text-cusGray cursor-pointer'>female</label>
                        ...
                        <div className="lg:px-20 mb-3">
                            ...
                            <input type="text" name='price' required className='input' placeholder='100000'
